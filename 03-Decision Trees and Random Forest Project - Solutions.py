...
# 
# For this project we will be exploring publicly available data from Lending club . Lending Club connects people who need money (borrowers) with people who have money (investors). Hopefully, as an investor you would want to invest in people who showed a profile of having a high probability of paying you back. We will try to create a model that will help predict this.
# 
...
# ** Creatig the following lmplots to see if the trend differed between not.fully.paid and credit.policy. Checking the documentation for lmplot()**
...
# 
# We can notice that the **purpose** column is categorical
# 
...
# 
# ** Using sklearn to split  data into a training set and a testing set as we've done in the past.**
...
# **Creating predictions from the test set and creatig a classification report and a confusion matrix.**
...
# **Creating a classification report from the results. Do you get anything strange or some sort of warning?**
...
# # Thank you! Hope you ave enjoyed te project.
